...
function getResult(r) {
  if (r === ReactNative.PermissionsAndroid.RESULTS.GRANTED) {
    return /* GRANTED */0;
  } else if (r === ReactNative.PermissionsAndroid.RESULTS.DENIED || r !== ReactNative.PermissionsAndroid.RESULTS.NEVER_ASK_AGAIN) {
    return /* DENIED */1;
  } else {
